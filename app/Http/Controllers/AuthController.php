...
class AuthController extends Controller
{
    ...
    public function store(){
        ...
        Mail::to($validated["email"])->send(new WelcomeMail($user));
    ...
    public function authenticate(){
        ...
        return redirect()->route("login")->withErrors(["error"=> "No matching users found with provided email and password"]);
    }
